...
from backend.api.deps import CurrentTeacher, CurrentStudent, SessionDep
from backend.logic.user import edit_student, edit_teacher
from backend.models import TeacherUpdate, UserMe, StudentUpdate
