...
from backend.api.deps import CurrentTeacher, SessionDep, CurrentUser
from backend.logic.class_ import (
    create_class,
    get_class_by_id,
    delete_class,
    edit_class,
...
from backend.models import ClassCreate, ClassPublic, ClassPublicWithRelations
