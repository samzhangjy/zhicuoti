...
if __name__ == "__main__":
    transformer = Transform("./data/predictor/ZHENGZHI-plain.json")
    # transformer.parse_tags("./data/predictor/zz-tags-2.json")
    # transformer.merge_files("./data/tmp", "./data/predictor/BIOLOGY-plain-1.json")
    transformer.transform_tags("./data/ZHENGZHI-processed.csv")
    # transformer.contigous_parse_tags("./data/ENG-7-tags.json", "./data/ENG-9-tags.json")
    # transformer.load_tags("./data/predictor/ZHENGZHI-tags.json", "./data/predictor/ZHENGZHI-2.json")
