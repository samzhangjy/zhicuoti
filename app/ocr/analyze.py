...
class ProblemAnalyzer:
    ...
    def predict_problems(self, image_path: str) -> dict:
        ...
        Returns:
            dict: Prediction result, in forms of `{"box": tuple[int, int, int, int], "text": str}`.
        """
        ...
        for box in result["boxes"]:
            ...
            ret.append({"box": tuple(box["coordinate"]), "text": text})
