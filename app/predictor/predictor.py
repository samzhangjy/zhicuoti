...
class Predictor:
    ...
    def __init__(
        self,
        data_path: str = "./data/MATH-6-tags.csv",
        cut_words: bool = True,
        ...
        Args:
            data_path (str, optional): The data path used to train the model.
                                       Defaults to "./data/MATH-6-tags.csv".
...
def test_model(
    ...
    if no_jieba:
        predictor_without_jieba = Predictor(data_path, cut_words=False)
        for val in values:
...
if __name__ == "__main__":
    # predictor = Predictor("./data/ENG-10-tags.csv")
    # X_test, y_test = predictor.train_model(5000, "random-forest")
    # loss = predictor.hamming_loss(y_test, predictor.predict_binary(X_test))
    # print(loss)
